...
<head>
	...
	<link href="<c:url value="/plugin/axu-1.1.1/theme/Barracks-cacao/admin/resource/axicon/axicon.css"/>" rel="stylesheet">
    <link href="<c:url value="/plugin/axu-1.1.1/asp/axj/axisj/ui/kakao/AXJ.min.css"/>" rel="stylesheet">
    <link href="<c:url value="/plugin/axu-1.1.1/theme/Barracks-cacao/admin/ui/cacao/admin.css"/>" rel="stylesheet">
    <script src="<c:url value="/plugin/axu-1.1.1/asp/axj/axisj/jquery/jquery.min.js"/>"></script>
    <script src="<c:url value="/plugin/axu-1.1.1/asp/axj/axisj/dist/AXJ.min.js"/>"></script>
