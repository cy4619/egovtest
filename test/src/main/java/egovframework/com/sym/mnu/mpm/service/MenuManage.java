...
public class MenuManage implements Serializable, Comparable<MenuManage>{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3127214823838211113L;
	/**
	 * 메뉴설명
	 */
	...
	private String key="";
	private MenuManage parent=null;
	
	public MenuManage(String menuNm, int menuOrdr, MenuManage parent, String progrmFileNm) {
		this.menuNm=menuNm;
		this.menuOrdr=menuOrdr;
		this.parent=parent;
		this.key=parent.key+(char)menuOrdr;
	}
	
	@Override
	public int compareTo(MenuManage o) {
